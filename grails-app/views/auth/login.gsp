  ...
  <div class="container">
    <main>
      <section class="login-section">
        ...
        <atlas-form method="POST" action="${createLink(controller: "auth", action: "doLogin")}">
        ...
        <hr class="divider" />
        <atlas-layout gap="4">
          <atlas-text class="subtitle" theme="secondary" size="xsm">Ainda não possui uma conta?</atlas-text>
          <div>
            <atlas-button
              class="btn__link"
              type="outlined"
