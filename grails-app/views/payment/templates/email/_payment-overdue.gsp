...
<html lang="pt-br">
	<head>
		...
		<title>Cobrança Vencida - Mini Asaas</title>
	...
	<body>
		<div class="container">
			...
			<div class="main">
				...
				<div>
					<p>
						Esta é uma mensagem automática para informar que a cobrança abaixo está vencida. Por favor, efetue o pagamento o quanto antes para evitar juros e multas.
					</p>
